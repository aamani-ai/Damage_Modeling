...
| `docs/damage_curves/damage_curve_foundations/` | Method docs | Compatibility pointer after migration | `docs/method/foundations/` | Moved | Durable method belongs outside deliverable-shaped navigation | Old folder README points to canonical foundations |
| `docs/method/foundations/` | Method docs | Canonical foundations/principles/question docs | `docs/method/foundations/` | Canonical | P1-P3, the six question docs, and the assembled-curve-record spec are method foundations | Link check; internal links resolve or remain within known legacy-debt baseline |
