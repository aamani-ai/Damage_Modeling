# Tropical-cyclone wind × solar — model v2.1 / docs r2
...
[curve artifact](tropical_cyclone_wind_solar__model_v2_1__docs_r2__curve_artifact.json), accompanied by the
[capability declaration](tropical_cyclone_wind_solar__model_v2_1__docs_r2__capability.json),
[known-answer tests](known_answer_tests_tropical_cyclone_wind_solar__model_v2_1__docs_r2.json), and
[workbook](damage_curve_records_tropical_cyclone_wind_solar__model_v2_1__docs_r2.xlsx). The
...
- [change classification](CHANGE_CLASSIFICATION_tropical_cyclone_wind_solar__model_v2_1__docs_r2.md)
- [decision log](DECISION_LOG_tropical_cyclone_wind_solar__model_v2_1__docs_r2.md)
- [derivation dossier](tropical_cyclone_wind_solar_curve_derivation_dossier__model_v2_1__docs_r2.md)
- [metadata contract](tropical_cyclone_wind_solar_damage_code_metadata_spec__model_v2_1__docs_r2.md)
- [old-vs-new table](OLD_VS_NEW_COMPARISON_tropical_cyclone_wind_solar__model_v2_1__docs_r2.csv)
