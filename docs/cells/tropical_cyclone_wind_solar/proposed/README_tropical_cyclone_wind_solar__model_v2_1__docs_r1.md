...
> **Outcome:** coverage-complete screening proposal. Numeric plant physical DR and scenario loss are now
> delivered. The model remains noncanonical and explicitly Tier-4 where calibration is absent.
