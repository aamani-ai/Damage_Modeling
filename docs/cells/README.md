...
|---|---|---|---|
| `hail_solar` | model v1.0 / docs r5 | `HAIL_SOLAR_PV_MODULE_V1` | [`hail_solar/`](hail_solar/README.md) |
| `flood_solar` | model v1.0 / docs r3 | `FLOOD_SOLAR_ELECTRICAL_INUNDATION_V1` | [`flood_solar/`](flood_solar/README.md) |
