...
scenario_loss: consumer-computable only with explicit same-unit direct replacement value and exposure
annual_and_tail_metrics: not emitted
```

Every numerical result carries the canonical-screening-release, Tier-4, partial-coverage, FSim-not-local-heat-flux,
