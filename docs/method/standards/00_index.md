...
```text
20_machine_readable_artifact_standard.md
...
hazard_modeling_handoff/README.md
```
...
| `09_damage_code_interface_standard.md` | Runtime damage-code interface and distribution-ready emit structure. |
| `10_review_checklist.md` | QA checklist before a cell is accepted. |
| `20_machine_readable_artifact_standard.md` | Canonical JSON artifact, parameter-role grouping, and runtime artifact requirements. |
| `21_capability_and_cap_binding_standard.md` | Metric capability declaration and cap-binding preflight gate. |
