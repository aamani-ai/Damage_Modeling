...
[`01`](01_granularity.md) had to curve-building: reason out the *system* first, fill
...
> **Why a guide, not a table (per [`01`](01_granularity.md)'s precedent).** We did not
...
precision the model can't use.** Doc [`01`](01_granularity.md) already fixed the grain
