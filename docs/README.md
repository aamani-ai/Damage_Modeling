...
| [`cells/`](cells/README.md) | Shallow entrypoints for all 10 structurally governed hazard × asset cells: 5 canonical runtime cells, 2 fail-closed model-v0.1 research cells, and 3 noncanonical partial-coverage model-v1.0 proposals. |
