...
> **New — start here:** [`SCOPE_AND_STORY.md`](SCOPE_AND_STORY.md) is the durable anchor for the whole
> damage-modeling effort — the three-phase arc, the tier/repo boundary, the damage↔hazard contract, and the
> migration plan. The `00`–`07` docs below are the original decision *scaffold*; the deeper, current body of
> work now lives in [`damage_curve_foundations/`](damage_curve_foundations/README.md) (principles + 6
> question-docs) and [`damage_curve_implementation/`](damage_curve_implementation/) (global method + 3 cells),
> which supersede the exploratory numbering.
...
| 01 | [`01_emit_object.md`](01_emit_object.md) | **The headline** — what M3 emits (scalar / mean+spread / state-vector / distribution); interface-vs-content; per-peril vs uniform. Builds on [`../gpt/04`](../../Hazard_modeling/docs/extra/discussion/gpt/04_damage_representation_scalar_vector_distribution.md). | 🔴 open (Q1, Q5) |
...
- The platform-level aggregation / double-counting discussion: [`../aggregation/`](../../Hazard_modeling/docs/extra/discussion/aggregation/README.md).
- The deeper prior treatment of the emit object: [`../gpt/04_damage_representation_scalar_vector_distribution.md`](../../Hazard_modeling/docs/extra/discussion/gpt/04_damage_representation_scalar_vector_distribution.md).
- The three-coupled-choices origin: [`../../../learning_logs/05_damage_curve_three_coupled_choices.md`](../../Hazard_modeling/docs/learning_logs/05_damage_curve_three_coupled_choices.md).
- The curve library (the source for M3 severity): [`../../../../infrasure-damage-curves`](../../infrasure-damage-curves).
- The methodology + terminology (Drive = source of truth): [`../../../google_drive_docs/README.md`](../../Hazard_modeling/docs/google_drive_docs/README.md) — §6 severity · §7 duration · §9 financial.
- The principles that govern every call: [`../../../principles/`](../../Hazard_modeling/docs/principles/README.md).
- Per-cell registers: [hail](../../Hazard_modeling/docs/plans/hail/assumptions.md) · [wildfire](../../Hazard_modeling/docs/plans/wildfire/decisions.md) · [convective-wind](../../Hazard_modeling/docs/plans/convective_wind/decisions.md).
- The scope-and-story anchor: [`../../00_scope_and_story.md`](../../Hazard_modeling/docs/extra/00_scope_and_story.md).
