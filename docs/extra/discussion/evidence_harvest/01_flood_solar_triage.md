...
cell-model bump, per [standard 17](../../../contracts/standards/17_versioning_policy.md)).
The transformer-selector / salinity / duration items are logged as **candidate model v1.1** changes for a
separate pass. One [standard-16](../../../method/standards/16_reference_ingestion_and_curve_update_protocol.md)
update to the [flood×solar dossier](../../../cells/flood_solar/current/flood_solar_curve_derivation_dossier_v1_0.md).
